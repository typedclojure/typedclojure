...
;; Test that the namespace loads
(println "Property test namespace loaded - CLR tests will run only on CLR platform")
...
;; CLR-only property tests - wrapped in reader conditional so they only run on CLR
#?(:cljr
   (do
