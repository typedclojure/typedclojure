<!-- DO NOT EDIT! Instead, edit `dev/resources/root-templates/typed/cljs.runtime/README.md` and run `./script/regen-selmer.sh` -->
# typed.cljs.runtime
...
```clj
  org.typedclojure/typed.cljs.runtime {:mvn/version "1.0.25"}
```
...
```clojure
[org.typedclojure/typed.cljs.runtime "1.0.25"]
```
