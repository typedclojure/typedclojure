...
(ns ^:no-doc clojure.core.typed.analyze-cljs
...
(defn extenders
  ...
  (or (get-in ((requiring-resolve 'cljs.analyzer/get-namespace) (symbol (namespace psym)))
...
(defn analyze-qualified-symbol 
  ...
  ((requiring-resolve 'cljs.analyzer/analyze-symbol)
   ((requiring-resolve 'cljs.analyzer/empty-env)) sym))
