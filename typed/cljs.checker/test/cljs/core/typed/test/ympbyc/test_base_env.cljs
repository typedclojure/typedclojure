...
;(ann cljs.core/-conj [t/Any t/Any -> (t/Coll t/Any)])
;(ann cljs.core.List.EMPTY (List t/Any)) ;;this fails somehow
...
;(ann conj-5 (t/Map Keyword t/Any))
