...
```clj
  org.typedclojure/typed.malli {:mvn/version "1.1.3"}
```
...
```clojure
[org.typedclojure/typed.malli "1.1.3"]
```
...
```clojure
clj -Sdeps '{:deps {org.typedclojure/typed.malli {:mvn/version "1.1.3"}
                    ;; only needed if omitting typed.clj.checker
                    org.typedclojure/typed.lib.clojure {:mvn/version "1.1.3"}
                    org.typedclojure/typed.clj.checker {:mvn/version "1.1.3"}}}'
```
