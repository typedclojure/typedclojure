...
```clj
  org.typedclojure/typed.malli {:mvn/version "1.0.25"}
```
...
```clojure
[org.typedclojure/typed.malli "1.0.25"]
```
...
```clojure
clj -Sdeps '{:deps {org.typedclojure/typed.malli {:mvn/version "1.0.25"}
                    ;; only needed if omitting typed.clj.checker
                    org.typedclojure/typed.lib.clojure {:mvn/version "1.0.25"}
                    org.typedclojure/typed.clj.checker {:mvn/version "1.0.25"}}}'
```
