...
```clj
  org.typedclojure/typed.malli {:mvn/version "1.1.5"}
```
...
```clojure
[org.typedclojure/typed.malli "1.1.5"]
```
...
```clojure
clj -Sdeps '{:deps {org.typedclojure/typed.malli {:mvn/version "1.1.5"}
                    ;; only needed if omitting typed.clj.checker
                    org.typedclojure/typed.lib.clojure {:mvn/version "1.1.5"}
                    org.typedclojure/typed.clj.checker {:mvn/version "1.1.5"}}}'
```
