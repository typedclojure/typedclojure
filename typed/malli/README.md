...
```clj
  org.typedclojure/typed.malli {:mvn/version "1.0.28"}
```
...
```clojure
[org.typedclojure/typed.malli "1.0.28"]
```
...
```clojure
clj -Sdeps '{:deps {org.typedclojure/typed.malli {:mvn/version "1.0.28"}
                    ;; only needed if omitting typed.clj.checker
                    org.typedclojure/typed.lib.clojure {:mvn/version "1.0.28"}
                    org.typedclojure/typed.clj.checker {:mvn/version "1.0.28"}}}'
```
