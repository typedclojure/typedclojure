...
;;js types
  clojure.core.typed.checker.type_rep.JSBoolean 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSObject 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSString 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSSymbol 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSNumber 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.CLJSInteger 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.ArrayCLJS 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.FunctionCLJS 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSUndefined 
  (frees [t] -empty-frees-result)
  clojure.core.typed.checker.type_rep.JSNull 
  (frees [t] -empty-frees-result))
