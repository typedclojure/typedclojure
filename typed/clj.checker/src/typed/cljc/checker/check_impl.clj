...
(ns ^:typed.clojure ^:no-doc typed.cljc.checker.check-impl
  ...
  (:require [clojure.core.typed.current-impl :as impl]
            ...
            [typed.cljc.checker.check.new :as new]
            ...
            [typed.cljc.checker.check.the-var :as the-var]
            [typed.cljc.checker.check.throw :as throw]
            [typed.cljc.checker.check.try :as try]
            [typed.cljc.checker.check.var :as var]
...
(defmethod -check ::ana2/const     [expr expected opts] (const/check-const         expr expected opts))
...
(defmethod -check ::ana2/new       [expr expected opts] (new/check-new             expr expected opts))
...
(defmethod -check ::ana2/set!      [expr expected opts] (set!/check-set!           expr expected opts))
(defmethod -check ::ana2/the-var   [expr expected opts] (the-var/check-the-var     expr expected opts))
...
(defmethod -check ::ana2/var       [expr expected opts] (var/check-var             expr expected opts))
