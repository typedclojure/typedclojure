...
(defn- forms->string [forms]
  {:pre [(vector? forms)]}
  (apply str (map ast->string forms)))
...
(defn ast->string
  ...
  (case (:op ast)
    ...
    ::map (str \{ (forms->string (:forms ast)) \})
    ::set (str "#{" (forms->string (:forms ast)) \})
    ::vector (str \[ (forms->string (:forms ast)) \])
    ::list (str \( (forms->string (:forms ast)) \))
    ::fn (str "#(" (forms->string (:forms ast)) \))
    ::quote (str \' (forms->string (:forms ast)))
    ::discard (str "#_" (forms->string (:forms ast)))
    ::meta (str \^ (forms->string (:forms ast)))
    ::deref (str \@ (forms->string (:forms ast)))
    ::unquote (str \~ (forms->string (:forms ast)))
    ::unquote-splicing (str "~@" (forms->string (:forms ast)))
    ::syntax-quote (str \` (forms->string (:forms ast)))

    (::symbol ::number ::whitespace ::boolean) (:string ast)

    ::string (str \" (:string ast) \")
    ::regex (str "#\"" (:string ast) \")
    ::namespaced-map (str "#:" (forms->string (:forms ast)))
    ::auto-namespaced-map (str "#::" (forms->string (:forms ast)))
    ::cond (str "#?" (forms->string (:forms ast)))
    ::cond-splicing (str "#?@" (forms->string (:forms ast)))
    ::comment (str \; (:string ast))
    ::keyword (str \: (:string ast))
    ::auto-keyword (str "::" (:string ast))
    ::symbolic-value (str "##" (:string ast))
    ::character (str \\ (:string ast))
    ::fn-arg (str \% (:string ast))
    ::tagged (str "#" (forms->string (:forms ast)))
    ::read-eval (str "#=" (forms->string (:forms ast)))
    ::ctor (str "#" (:tag-sym ast) (forms->string (:forms ast)))
