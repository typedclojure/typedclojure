...
;; based on clojure.tools.reader.impl.commons
(ns typed.clj.reader.impl.commons
  (:refer-clojure :exclude [char])
  (:require [typed.clj.reader.reader-types :refer [peek-char read-char]]
            [typed.clj.reader.impl.errors :refer [reader-error]]
            [typed.clj.reader.impl.utils :refer [numeric? newline? char]])
...
(defn read-past+skipped
  "Read until first character that doesn't match pred, returning
   tuple of skipped string and matching char."
  [pred rdr]
