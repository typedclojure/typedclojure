<!-- DO NOT EDIT! Instead, edit `dev/resources/root-templates/typed/lib.clojure/README.md` and run `./script/regen-selmer.sh` -->
# typed.lib.clojure
...
```clojure
[org.typedclojure/typed.lib.clojure "1.0.25"]
```
