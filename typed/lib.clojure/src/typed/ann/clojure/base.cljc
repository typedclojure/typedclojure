...
(ns ^:typed.clojure ^:no-doc typed.ann.clojure.base
  "Base type annotations for the Clojure distribution - supports JVM and CLR."
  (:require [typed.clojure :as t]
            #?(:clj [typed.clojure.jvm :refer [override-classes]]
               ;; TODO clr-specific env or platform-independent ns
