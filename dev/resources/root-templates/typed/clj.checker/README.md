...
* [All Released Versions](https://clojars.org/{◊typedclojure-group-id◊}/typed.clj.checker)
...
```clj
  {◊typedclojure-group-id◊}/typed.clj.checker
...
```clojure
[{◊typedclojure-group-id◊}/typed.clj.checker "{◊typedclojure-stable-mvn-version◊}"]
```
