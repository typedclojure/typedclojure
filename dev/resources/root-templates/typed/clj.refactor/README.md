...
* [All Released Versions](https://clojars.org/{◊typedclojure-group-id◊}/typed.clj.refactor)

[deps.edn](https://clojure.org/reference/deps_and_cli) JAR dependency information:

```clj
  {◊typedclojure-group-id◊}/typed.clj.refactor {:mvn/version "1.0.12"}
```
...
```clojure
[{◊typedclojure-group-id◊}/typed.clj.refactor "1.0.12"]
```
