...
* [All Released Versions](https://clojars.org/{◊typedclojure-group-id◊}/typed.clj.lang)

[deps.edn](https://clojure.org/reference/deps_and_cli) JAR dependency information:

```clj
  {◊typedclojure-group-id◊}/typed.clj.lang {:mvn/version "{◊typedclojure-stable-mvn-version◊}"}
 ```
...
```clj
  {◊typedclojure-group-id◊}/typed.clj.lang
...
```clojure
[{◊typedclojure-group-id◊}/typed.clj.lang "{◊typedclojure-stable-mvn-version◊}"]
```
