...
```clojure
{:deps {org.typedclojure/typed.clj.runtime {:mvn/version "1.1.4"}}
 :aliases {:dev {:extra-deps {org.typedclojure/typed.clj.checker {:mvn/version "1.1.4"}}}}}
```
...
(defproject com.my-domain/a-project "1.0.0-SNAPSHOT"
  :dependencies [[org.typedclojure/typed.clj.runtime "1.1.4"]]
  :profiles {:dev {:dependencies [[org.typedclojure/typed.clj.checker "1.1.4"]]}})
```
