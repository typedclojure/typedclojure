...
```clojure
{:deps {typed.clj/runtime {:mvn/version "1.0.13"}}
 :aliases {:dev {:extra-deps {typed.clj/checker {:mvn/version "1.0.13"}}}}}
```
...
(defproject a-project "0.0.1-SNAPSHOT"
  :dependencies [[typed.clj/runtime "1.0.13"]]
  :profiles {:dev {:dependencies [[typed.clj/checker "1.0.13"]]}})
```
